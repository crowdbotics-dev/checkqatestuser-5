"""
Django settings for checkqatestuser_5 project.
...
ROOT_URLCONF = 'checkqatestuser_5.urls'
...
WSGI_APPLICATION = 'checkqatestuser_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "checkqatestuser_5 API",
    "DESCRIPTION": "API documentation for checkqatestuser_5 App",
    "VERSION": "v1",
}
